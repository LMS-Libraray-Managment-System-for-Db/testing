<h1>Test Scenarios Repository</h1>
        ...
        <ul>
            ...
            <li><strong>Test Output:</strong> The raw output of the test run.</li>
        </ul>
...
<h2>Getting Started</h2>
 ...
 <h3>Viewing the Reports</h3>
        <ul>
            ...
            <li><strong>Test Tool Report:</strong> Open the <code>test_tool_report.html</code> file in a web browser to see the detailed report generated by the test tool.</li>
            <li><strong>Test Output:</strong> The <code>output.log</code> file contains the raw output of the test run, which can be viewed in any text editor.</li>
